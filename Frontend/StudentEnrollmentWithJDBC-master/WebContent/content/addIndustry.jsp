      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <form class="bg-primary" id="myForm" method="post" name="myForm"
            ...
            <div class="form-group"> <label for="InputName">Industry Name</label>
              <input type="text" class="form-control" id="clientName" name="clientName" placeholder="Client ID"> </div>
       <INPUT type=button value="Add Industry" name="btaddquestion" onclick="fnSubmit()">
