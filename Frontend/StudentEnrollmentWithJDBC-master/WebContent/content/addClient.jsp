...
<body>
  ...
  <div class="py-5 bg-primary text-white">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1>Add Client screen</h1>
          <form class="bg-primary" id="myForm" method="post" name="myForm"
							 action="../StudentController">
							 <input type="hidden" name="pageName" value="addClient">
            <div class="form-group"> <label for="InputName">Client Name</label>
             <input type="text" id="clientName" name="clientName"> </div>
       		<INPUT type=button value="Add Client" name="btaddClient" onclick="fnSubmit()">
